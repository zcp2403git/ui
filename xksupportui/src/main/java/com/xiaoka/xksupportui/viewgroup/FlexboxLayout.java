...
//
//    public List<FlexLine> mFlexLines = new ArrayList<>();
//
//    /**
...
//                attrs, R.styleable.MyFlexboxLayout, defStyleAttr, 0);
//        mFlexDirection = a.getInt(R.styleable.MyFlexboxLayout_flexDirection, FLEX_DIRECTION_ROW);
//        mFlexWrap = a.getInt(R.styleable.MyFlexboxLayout_flexWrap, FLEX_WRAP_NOWRAP);
//        mJustifyContent = a
//                .getInt(R.styleable.MyFlexboxLayout_justifyContent, JUSTIFY_CONTENT_FLEX_START);
//        mAlignItems = a.getInt(R.styleable.MyFlexboxLayout_alignItems, ALIGN_ITEMS_STRETCH);
//        mAlignContent = a.getInt(R.styleable.MyFlexboxLayout_alignContent, ALIGN_CONTENT_STRETCH);
//        a.recycle();
//    }
//
//    @Override
...
//                    if (mFlexLines.size()<maxLines) {
//                        flexLine.mainSize += (paddingStart + paddingEnd);
//                        Log.d("asa",flexLine.itemCount+"");
...
//                    .obtainStyledAttributes(attrs, R.styleable.MyFlexboxLayout_Layout);
//            order = a.getInt(R.styleable.MyFlexboxLayout_Layout_layout_order, ORDER_DEFAULT);
//            flexGrow = a
//                    .getFloat(R.styleable.MyFlexboxLayout_Layout_layout_flexGrow, FLEX_GROW_DEFAULT);
//            flexShrink = a.getFloat(R.styleable.MyFlexboxLayout_Layout_layout_flexShrink,
//                    FLEX_SHRINK_DEFAULT);
//            alignSelf = a
//                    .getInt(R.styleable.MyFlexboxLayout_Layout_layout_alignSelf, ALIGN_SELF_AUTO);
//            flexBasisPercent = a
//                    .getFraction(R.styleable.MyFlexboxLayout_Layout_layout_flexBasisPercent, 1, 1,
//                            FLEX_BASIS_PERCENT_DEFAULT);
//            minWidth = a.getDimensionPixelSize(R.styleable.MyFlexboxLayout_Layout_layout_minWidth, 0);
//            minHeight = a
//                    .getDimensionPixelSize(R.styleable.MyFlexboxLayout_Layout_layout_minHeight, 0);
//            maxWidth = a.getDimensionPixelSize(R.styleable.MyFlexboxLayout_Layout_layout_maxWidth,
//                    MAX_SIZE);
//            maxHeight = a.getDimensionPixelSize(R.styleable.MyFlexboxLayout_Layout_layout_maxHeight,
//                    MAX_SIZE);
//            wrapBefore = a.getBoolean(R.styleable.MyFlexboxLayout_Layout_layout_wrapBefore, false);
//            a.recycle();
//        }
//
