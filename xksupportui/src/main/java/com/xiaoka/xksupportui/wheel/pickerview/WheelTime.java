...
//		ALL, YEAR_MONTH_DAY, HOURS_MINS, MONTH_DAY_HOUR_MIN
    ...
    public WheelTime(View view, int type) {
        super();
        this.view = view;
        this.type = type;
        setView(view);
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        wv_year.setLabel(context.getString(R.string.wheel_year));// 添加文字
        wv_year.setCurrentItem(year - START_YEAR);// 初始化时显示的数据

        // 月
        wv_month = (WheelView) view.findViewById(R.id.month);
        wv_month.setAdapter(new NumericWheelAdapter(1, 12));
        wv_month.setLabel(context.getString(R.string.wheel_month));
        ...
        wv_day.setLabel(context.getString(R.string.wheel_day));
        wv_day.setCurrentItem(day - 1);

        wv_hours = (WheelView) view.findViewById(R.id.hour);
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23));
        wv_hours.setLabel(context.getString(R.string.wheel_hours));// 添加文字
        wv_hours.setCurrentItem(h);

        wv_mins = (WheelView) view.findViewById(R.id.min);
        wv_mins.setAdapter(new NumericWheelAdapter(0, 59));
        wv_mins.setLabel(context.getString(R.string.wheel_minutes));// 添加文字
        ...
        switch (type) {
            ...
            case Type.YEAR_MONTH_DAY:
                ...
                break;
            case Type.HOURS_MINS:
                textSize = (screenheight / 100) * 4;
                wv_year.setVisibility(View.GONE);
                wv_month.setVisibility(View.GONE);
                wv_day.setVisibility(View.GONE);
                break;
            case Type.MONTH_DAY_HOUR_MIN:
                textSize = (screenheight / 100) * 3;
                wv_year.setVisibility(View.GONE);
                break;
            default:
